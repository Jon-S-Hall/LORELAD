        ...
        <main>
          <section id="top" className={styles.top}>
            <div className={styles.top_content}>
              ...
              <div className={` ${styles.top_cta_button} ${styles.md_lg}`}>
                <p className={styles.lg}>Get Started</p>
                <p className={styles.sm_md}>How It Works</p>
                <a href="#cta">
                  <svg
                    width="70"
                    height="30"
          ...
          <section id="cta" className={styles.cta}>
            <div className={styles.cta_content}>
              <div className={styles.speaker}>
                <p className={styles.md_lg}>
                  Are you a low-resource language speaker?
                </p>
                <button>
                  <svg
                    width="46"
                  ...
                  >
                    <path
                      d="M23 1.83337C21.475 1.83337 20.0125 2.41284 18.9341 3.44429C17.8558 4.47574 17.25 5.87468 17.25 7.33337V22C17.25 23.4587 17.8558 24.8577 18.9341 25.8891C20.0125 26.9206 21.475 27.5 23 27.5C24.525 27.5 25.9875 26.9206 27.0659 25.8891C28.1442 24.8577 28.75 23.4587 28.75 22V7.33337C28.75 5.87468 28.1442 4.47574 27.0659 3.44429C25.9875 2.41284 24.525 1.83337 23 1.83337V1.83337Z"
                      stroke="white"
                      stroke-width="3"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M36.4166 18.3334V22C36.4166 25.4037 35.003 28.6679 32.4869 31.0746C29.9708 33.4813 26.5582 34.8334 22.9999 34.8334C19.4416 34.8334 16.029 33.4813 13.5129 31.0746C10.9968 28.6679 9.58325 25.4037 9.58325 22V18.3334"
                      stroke="white"
                      stroke-width="3"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                  ...
                  <a href="/explore/recordings">Make A Recording</a>
                </button>
              </div>
              <div className={styles.researcher}>
                ...
                <Link href="/explore">
                  <button>
                    ...
                    >
                      <path
                        d="M7.26379 16.6667C6.97706 17.7557 6.83241 18.8757 6.83329 20C6.83329 21.15 6.98363 22.2667 7.26379 23.3334H12.1291C11.8988 21.1168 11.8988 18.8833 12.1291 16.6667H7.26379ZM8.66121 13.3334H12.669C13.1234 11.305 13.7794 9.48837 14.584 7.97671C12.1038 9.14241 10.0402 11.0088 8.66121 13.3334ZM33.7361 16.6667H28.8708C29.1011 18.8833 29.1011 21.1168 28.8708 23.3334H33.7361C34.3113 21.1466 34.3113 18.8535 33.7361 16.6667ZM32.3387 13.3334C30.9597 11.0088 28.8961 9.14241 26.4159 7.97671C27.2223 9.48837 27.8765 11.305 28.331 13.3334H32.3387ZM15.5663 16.6667C15.4383 17.7734 15.3744 18.8863 15.375 20C15.375 21.1417 15.4399 22.2584 15.5663 23.3334H25.4336C25.6909 21.1182 25.6909 18.8818 25.4336 16.6667H15.5663ZM16.1779 13.3334H24.822C24.5112 12.0805 24.0627 10.8641 23.4844 9.70504C22.4116 7.61337 21.2636 6.66671 20.5 6.66671C19.7346 6.66671 18.5883 7.61337 17.5155 9.70504C16.9774 10.7584 16.5247 11.9834 16.1779 13.3334ZM8.66121 26.6667C10.0402 28.9913 12.1038 30.8577 14.584 32.0234C13.7777 30.5117 13.1234 28.695 12.669 26.6667H8.66121ZM32.3387 26.6667H28.331C27.8765 28.695 27.2205 30.5117 26.4159 32.0234C28.8961 30.8577 30.9597 28.9913 32.3387 26.6667ZM16.1779 26.6667C16.5247 28.0167 16.9774 29.2417 17.5155 30.295C18.5883 32.3867 19.7363 33.3334 20.5 33.3334C21.2653 33.3334 22.4116 32.3867 23.4844 30.295C24.0225 29.2417 24.4753 28.0167 24.822 26.6667H16.1779ZM20.5 36.6667C11.0648 36.6667 3.41663 29.205 3.41663 20C3.41663 10.795 11.0648 3.33337 20.5 3.33337C29.9351 3.33337 37.5833 10.795 37.5833 20C37.5833 29.205 29.9351 36.6667 20.5 36.6667Z"
                        fill="white"
                      />
                    </svg>
                    <a href="">
                      Explore{" "}
                      <span className={styles.md_lg}>Low Resource </span>
                      Languages
                    </a>
                  </button>
                </Link>
            ...
            <div className={`${styles.top_cta_button} ${styles.sm}`}>
              <p>How It Works</p>
              <a href="#cta">
                <svg
                  width="70"
            ...
            <div className={`${styles.right_content} ${styles.sm_md}`}>
              <div className={styles.svgs}>
                <svg
                  width="50"
                  height="50"
              ...
              <div>
                ...
                <p>Submit the audio to be translated by yourself and others.</p>
                <p>
