...
// Example page of what a Language Page would look like

const Taishanese = () => (
  <Layout title="Taishanese">
    <div>
      <Head>
        <title>Taishanese</title>
        {/* Favicon */}
      ...
      <main className={styles.main}>
        ...
        <section className={styles.about_container}>
          ...
          <div className={styles.top}>
            <img src="/taishanese_img.png" alt="taishanese_img" />
            <div>
              <p>
                <span>Taishanese</span>, or in the Cantonese romanization
                Toisanese (simplified Chinese: 台山话; traditional Chinese:
                台山話; Taishanese: [hɔi˨san˧wa˧˨˥]), is a dialect of Yue
                Chinese. The dialect is related to and is often referred to as
                Cantonese but has little mutual intelligibility with the latter.
              </p>
              <p>
                Taishanese is spoken in the southern part of Guangdong Province
                in China, particularly around the city-level county of Taishan
