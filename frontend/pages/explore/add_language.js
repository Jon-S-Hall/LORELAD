      ...
      >
        <main className={styles.main}>
          ...
          <div className={styles.top_message}>
            We're sorry if you're language is currently not featured on LORELAD!
            We'd love if you could introduce us though! Please tell us all about
            it.
          </div>
          <form onSubmit={this.handle_submit}>
            <div>
              <label for="name">Languages Name</label>
              <p>
                If there's no english spelling or you're unsure, just sound it
                out!
              </p>
              <input
                type="text"
            ...
            <div>
              ...
              <p>If you're not sure, an estimate works!</p>
              <input
                type="text"
                id="num_speakers"
                value={this.state.num_speakers}
                placeholder="How many people speak language?"
                onChange={this.handle_change}
              />
            </div>
            <div>
              <label for="summary">Tell us something about the language!</label>
              <textarea
                type="text"
                id="summary"
                value={this.state.summary}
                placeholder="Talk about your language!"
                rows="10"
                onChange={this.handle_change}
              />
            </div>
            <div>
              <label for="cov_image">
                Upload a cover photo for the language!
              </label>
              <input
                type="file"
                id="cov_image"
            ...
            <div>
              ...
              <select
                ...
                required
              >
                <option onChange={this.handle_change} value="Africa">
                  Africa
                </option>
                <option onChange={this.handle_change} value="Asia">
                  Asia
                </option>
                <option onChange={this.handle_change} value="Australia">
                  Australia
                </option>
                <option onChange={this.handle_change} value="Europe">
                  Europe
                </option>
                <option onChange={this.handle_change} value="North America">
                  North America
                </option>
                <option onChange={this.handle_change} value="South America">
                  South America
                </option>
              </select>
            </div>
